                                ...
                                <div class = "col-sm-6 banner-info background-color:lightblue" >
                                    <div class="leftBox">
                                        <div class="content">
                                            ...
                                            <?php
                                            $query = "SELECT * FROM project_report INNER JOIN studentproject on project_report.studentname=studentproject.Student_name ";
                                            ...
                                            if (mysqli_num_rows($result) == 0) {
                                                ...
                                                while ($path = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '<tr>';
                                                    echo'  <th>' . $path['Student_name'] . '</th>';
                                                    echo'  <th><a href=../uploads/' . $path['path'] . '>Download</a></th>';
