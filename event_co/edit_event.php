...
if (isset($_POST["update"])) {
    ...
    $res = mysqli_query($conn, "UPDATE event set event_name='$event_name',location='$location',date='$date',event_type='$event_type' WHERE event_id='$event_id'");
    if ($res) {
        header("location:edit_event.php?id=$event_id&update=success");
    }
}
?>
<html>
                ...
                <div  class ="col-md-6 well">   
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="panel-title"><h2>Edit Event</h2></div>
